app.directive("board", ["startHour", "endHour", function(startHour, endHour) {
  return {
    restrict: "AE",
    link: function(scope) {
      ...
      createHourlyDay (startHour, endHour);

      function createHourlyDay (startHour, endHour) {
        ...
        for (var i=startHour; i<endHour; i++) {
          ...
          scope.emptyDate.push({time: time, title: "-"});
